...
public class EditTreeMilestone3Test {
	...
	public boolean attemptConcatenation(EditTree t1, EditTree t2) {
		...
		System.out.println("t1: "+t1.toDebugString());
		System.out.println("t2: "+t2.toDebugString());

		t1.concatenate(t2);
		
		System.out.println("t1&t2: "+t1.toDebugString());
		...
		System.out.println("maxNwHit: "+newHT1);
		System.out.println("expected: "+newHT1);
